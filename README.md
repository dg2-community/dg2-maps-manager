...
- Provide a built-in catalog for discovery. Instead of hunting through scattered links, the manager gives you one place to browse known DG2 community maps and see which ones are already in your local library.
